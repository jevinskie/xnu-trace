...
__MIG_check__Reply__mach_exception_raise_t(__Reply__mach_exception_raise_t *Out0P) {
...
mig_external kern_return_t mach_exception_raise(mach_port_t exception_port, mach_port_t thread,
...
#pragma pack(pop)
    ...
    __BeforeSendRpc(2405, "mach_exception_raise") msg_result =
        mach_msg(&InP->Head, MACH_SEND_MSG | MACH_RCV_MSG | MACH_MSG_OPTION_NONE, msgh_size,
                 (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE,
                 MACH_PORT_NULL);
    __AfterSendRpc(2405, "mach_exception_raise") if (msg_result != MACH_MSG_SUCCESS) {
...
mig_internal kern_return_t
__MIG_check__Reply__mach_exception_raise_state_t(__Reply__mach_exception_raise_state_t *Out0P) {
    ...
    if ((Out0P->Head.msgh_bits & MACH_MSGH_BITS_COMPLEX) ||
        ((msgh_size > (mach_msg_size_t)sizeof(__Reply) ||
          msgh_size < (mach_msg_size_t)(sizeof(__Reply) - 5184)) &&
...
#pragma pack(pop)
    ...
    __BeforeSendRpc(2406, "mach_exception_raise_state") msg_result =
        mach_msg(&InP->Head, MACH_SEND_MSG | MACH_RCV_MSG | MACH_MSG_OPTION_NONE, msgh_size,
                 (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE,
                 MACH_PORT_NULL);
    __AfterSendRpc(2406, "mach_exception_raise_state") if (msg_result != MACH_MSG_SUCCESS) {
        __MachMsgErrorWithoutTimeout(msg_result);
    }
    if (msg_result != MACH_MSG_SUCCESS) {
        { return msg_result; }
...
mig_external kern_return_t mach_exception_raise_state_identity(
    ...
    mach_exception_data_t code, mach_msg_type_number_t codeCnt, int *flavor,
...
#pragma pack(pop)
    ...
    __BeforeSendRpc(2407, "mach_exception_raise_state_identity") msg_result =
        mach_msg(&InP->Head, MACH_SEND_MSG | MACH_RCV_MSG | MACH_MSG_OPTION_NONE, msgh_size,
                 ...
                 MACH_PORT_NULL);
    __AfterSendRpc(2407,
                   "mach_exception_raise_state_identity") if (msg_result != MACH_MSG_SUCCESS) {
        __MachMsgErrorWithoutTimeout(msg_result);
    }
    if (msg_result != MACH_MSG_SUCCESS) {
        { return msg_result; }
